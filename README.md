...
* **Kullanıcı Yetkilendirme:** Sistem rollerine göre güvenli giriş paneli.
...
* **İşlem Kaydı ve Raporlama:** Satışların MySQL veritabanına ve yerel dosya sistemine (`sales.txt`) eşzamanlı kaydedilmesi.
